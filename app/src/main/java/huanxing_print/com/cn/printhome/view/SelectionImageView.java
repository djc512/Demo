...
public class SelectionImageView extends ImageView {
    ...
    public SelectionImageView(Context context) {
        super(context);
        init(null, 0);
    }

    public SelectionImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public SelectionImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mBorderPaint.setColor(ContextCompat.getColor(getContext(), R.color.red));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mSelectionPath.moveTo((float) mUpperLeftPoint.x, (float) mUpperLeftPoint.y);
        mSelectionPath.lineTo((float) mUpperRightPoint.x, (float) mUpperRightPoint.y);
        mSelectionPath.lineTo((float) mLowerRightPoint.x, (float) mLowerRightPoint.y);
        mSelectionPath.lineTo((float) mLowerLeftPoint.x, (float) mLowerLeftPoint.y);
        ...
        canvas.drawCircle((float) mUpperLeftPoint.x, (float) mUpperLeftPoint.y, 30, mCirclePaint);
        canvas.drawCircle((float) mUpperRightPoint.x, (float) mUpperRightPoint.y, 30, mCirclePaint);
        canvas.drawCircle((float) mLowerRightPoint.x, (float) mLowerRightPoint.y, 30, mCirclePaint);
        canvas.drawCircle((float) mLowerLeftPoint.x, (float) mLowerLeftPoint.y, 30, mCirclePaint);
    }
...
//                    Point point = new Point(event.getX(),event.getY());
    ...
    private PointF mapPointToMatrix(PointF point, Matrix matrix) {
        float[] points = new float[]{(float) point.x, (float) point.y};
