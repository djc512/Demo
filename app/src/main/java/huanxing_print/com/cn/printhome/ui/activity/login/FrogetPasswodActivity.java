...
public class FrogetPasswodActivity extends BaseActivity implements View.OnClickListener {
...
//                    ToastUtil.showToast(FrogetPasswodActivity.this,"请输入验证码");
//                    return;
//                }
                startActivity(new Intent(FrogetPasswodActivity.this,ModifyPassWordActivity.class));
                break;
