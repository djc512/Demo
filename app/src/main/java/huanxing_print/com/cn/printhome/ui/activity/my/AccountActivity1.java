...
public class AccountActivity1 extends BaseActivity implements View.OnClickListener {
    ...
    private AccountCZAdapter1 adapter1;
    ...
    public class MyChongzhiCallBack extends ChongzhiCallBack {
        ...
        public void success(String msg, List<ChongZhiBean> list) {
            ...
            adapter1 = new AccountCZAdapter1(getSelfActivity(),null);
            rv_account.setAdapter(adapter1);
            adapter1.setOnItemClickLitener(new AccountCZAdapter1.OnItemClickLitener() {
                @Override
