...
public class FailureRedEnvelopesDialog extends Dialog implements View.OnClickListener {
    ...
    public FailureRedEnvelopesDialog(@NonNull Context context) {
        super(context);
        this.context = context;
    }

    public FailureRedEnvelopesDialog(@NonNull Context context, @StyleRes int themeResId) {
        super(context, themeResId);
        this.context = context;
    }

    protected FailureRedEnvelopesDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_red_package_dialog_failure);
        init();
    }
