...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected void sendRedPackageMessage(String remark, String packetId) {
        if (EaseAtMessageHelper.get().containsAtUsername(remark)) {
            sendAtMessage(remark);
        } else {
            EMMessage message = EaseCommonUtils.createRedPackageMessage(toChatUsername, remark, packetId);
            sendMessage(message);
        }
    ...
    protected void forwardMessage(String forward_msg_id) {
        ...
        switch (type) {
            case TXT:
                ...
                } else if (forward_msg.getBooleanAttribute(EaseConstant.MESSAGE_IS_RED_PACKAGE, false)) {
                    sendRedPackageMessage(((EMTextMessageBody) forward_msg.getBody()).getMessage(),
                            forward_msg.getStringAttribute(EaseConstant.MESSAGE_RED_PACKAGE_ID, null));
                } else {
